...
void Meter::update_values(uint8_t value)
{
    newValue= value;
...
void Meter::paintEvent(QPaintEvent *)
{
    ...
    pen.setWidth(5);
    painter.setPen(pen);
    painter.drawArc(QRect(50,80,200,200),30*16,190*16);

    pen.setColor(QColor(QString("#E27930")));
    painter.setPen(pen);
    painter.drawArc(QRect(50,80,200,200),-10*16,60*16);

    pen.setColor(QColor(QString("#F82019")));
    painter.setPen(pen);
    painter.drawArc(QRect(50,80,200,200),-40*16,30*16);

    pen.setColor(QColor(QString("#2C2B2B")));
    pen.setWidth(45);
    painter.setPen(pen);
    painter.drawArc(QRect(75,105,150,150),-30*16,240*16);

    pen.setColor(arcColor);
    pen.setWidth(40);
    painter.setPen(pen);
    painter.drawArc(QRect(76,106,147,147),-150*16,-(m_value*spanfactor)*16);
    ...
    painter.setPen(pen);
    painter.drawText(QRect(50,30,150,150),QString(meterTitle));
    painter.drawText(QRect(100,250,80,80),QString::number(m_value));
    painter.drawText(QRect(170,250,100,100),QString(meterUnit));
