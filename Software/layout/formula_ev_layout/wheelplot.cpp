...
void WheelPlot::setupRealtimeBarGraph(QCustomPlot *customPlot)
{
   ...
   /* QLinearGradient gradient(0, 0, 0, 400);
    ...
    customPlot->setBackground(QBrush(QColor(QString("#252424")),Qt::SolidPattern));
    ...
    fossil->setName("Wheel Speed");
    fossil->setPen(QPen(QColor(QString("#E27930"))));
    fossil->setBrush(QColor(QString("#E27930")));
